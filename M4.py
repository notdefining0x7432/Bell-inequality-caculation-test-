...
COEFFICIENTS = {
    (0, 0, 0, 0):  1/4,  # A1B1C1D1
    (0, 0, 0, 1):  1/4,  # A1B1C1D2
    (0, 0, 1, 0): 1/4,  # -A1B1C2D1
    (0, 0, 1, 1):  1/4,  # +A1B1C2D2
    (0, 1, 0, 0):  1/4,  # +A1B2C1D1
    (0, 1, 0, 1):  1/4,  # +A1B2C1D2
    (0, 1, 1, 0): 1/4,  # -A1B2C2D1
    (0, 1, 1, 1): 1/4,  # -A1B2C2D2
    (1, 0, 0, 0):  1/4,  # +A2B1C1D1
    (1, 0, 0, 1):  1/4,  # +A2B1C1D2
    (1, 0, 1, 0): 1/4,  # -A2B1C2D1
    (1, 0, 1, 1): 1/4,  # -A2B1C2D2
    (1, 1, 0, 0):  1/4,  # +A2B2C1D1
    (1, 1, 0, 1): -1/4,  # -A2B2C1D2
    (1, 1, 1, 0): -1/4,  # -A2B2C2D1
    (1, 1, 1, 1): -1/4,  # -A2B2C2D2
}

# 5. 高级参数（通常保持默认即可，遇到多方复杂不等式时可调整）
METHOD = 'qutip'  # 'auto'(自动), 'toqito'(仅两方/严格上界), 'qutip'(多方/需优化)
